...
import com.ftninformatika.jwd.modul3.cinema.support.FestivalToFestivalDto;
...
@RestController
@RequestMapping(value = "/api/festival", produces = MediaType.APPLICATION_JSON_VALUE)
...
//  @PreAuthorize("hasRole('ADMIN')")
  @PreAuthorize("hasAnyRole('KORISNIK', 'ADMIN')")
	@GetMapping
	public ResponseEntity<List<FestivalDTO>> getAll(@RequestParam(required = false) String naziv) {

		List<Festival> findAll = service.findAll();
